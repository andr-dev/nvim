...
function gruvcrate.terminal_color()
  vim.g.terminal_color_0  = gruvcrate.black
...
function gruvcrate.load_syntax()
  local syntax = {
    ...
    IncSearch                       = {fg = gruvcrate.bg0, bg = gruvcrate.dark_yellow},
    Search                          = {fg = gruvcrate.bg0, bg = gruvcrate.dark_yellow},
    ...
    Number                          = {fg = gruvcrate.purple},
    Float                           = {fg = gruvcrate.purple},
    Boolean                         = {fg = gruvcrate.purple},
    ...
    PreProc                         = {fg = gruvcrate.purple},
    PreCondit                       = {fg = gruvcrate.purple},
    Include                         = {fg = gruvcrate.purple},
    Keyword                         = {fg = gruvcrate.purple},
    Define                          = {fg = gruvcrate.purple},
    Typedef                         = {fg = gruvcrate.purple},
    Exception                       = {fg = gruvcrate.purple},
    Conditional                     = {fg = gruvcrate.purple},
    Repeat                          = {fg = gruvcrate.purple},
    Statement                       = {fg = gruvcrate.purple},
