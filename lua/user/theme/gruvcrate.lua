...
function gruvcrate.load_syntax()
  local syntax = {
    -- common
    Normal                          = {fg = gruvcrate.fg0, bg = gruvcrate.bg0},
    Terminal                        = {fg = gruvcrate.fg0, bg = gruvcrate.bg0},
    ...
    Define                          = { link = "PreCondit" },
    Include                         = {fg = gruvcrate.red},
    Macro                           = {fg = gruvcrate.blue},
    PreCondit                       = {fg = gruvcrate.red},
    PreProc                         = {fg = gruvcrate.blue},

    StorageClass                    = {fg = gruvcrate.white},
